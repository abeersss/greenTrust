...
// ISR: same reasoning as /insights and /intelligence -- this page
// makes no dynamic API calls, so without this it would be cached
// fully static at build time and the "Latest CyberAbeer Insights" /
// "Latest Cyber Intelligence" sections would never pick up newly
// auto-published articles without a full redeploy.
