...
import { FounderToolResourceCard } from "@/components/founder/founder-tool-resource-card";
 ...
 * is_active rows. Each row can also be edited in place (name,
 * description, and optionally the media) via FounderToolResourceCard.
 */
  ...
  return (
    <div>
      ...
      <div className="mt-3 space-y-4">
        {tools.map((tool) => (
          <FounderToolResourceCard key={tool.id} locale={l} tool={tool} />
        ))}
